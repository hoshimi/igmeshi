...
class DetailForm extends React.Component {
    ...
    updateEffectDesc(newState, language) {
        ...
        if(newState["Effect2"] != "") {
            let desc = effects_descriptions[newState["Effect2"]][language].desc;
            let descAmount = effects_descriptions[newState["Effect2"]][language].amount;
        ...
        if(newState["Effect3"] != "") {
            let desc = effects_descriptions[newState["Effect3"]][language].desc;
            let descAmount = effects_descriptions[newState["Effect3"]][language].amount;
